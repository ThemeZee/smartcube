 ...
 * Slug: smartcube/magazine-double
...
<div class="wp-block-columns" style="margin-top:2vw">
	...
	<div class="wp-block-column" style="flex-basis:50%">
		...
		<!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"spacing":{"margin":{"bottom":"1.5vw"}}},"className":"is-style-sidebar-title","fontSize":"small"} -->
		<h2 class="is-style-sidebar-title has-small-font-size" style="font-style:normal;font-weight:400;margin-bottom:1.5vw"><?php _e( 'Category Title', 'smartcube' ); ?></h2>
		<!-- /wp:heading -->
