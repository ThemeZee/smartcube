...
/**
 * Title: Front Page
 * Slug: smartcube/page-layout-front
...
<div class="wp-block-group" style="margin-bottom:4vw">
	...
	<!-- wp:heading {"level":1} -->
	<h1><?php _e( 'Pursue your passion. Make your dreams come true.', 'smartcube' ); ?></h1>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<!-- wp:heading -->
			<h2><?php _e( 'Project One', 'smartcube' ); ?></h2>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:heading -->
			<h2><?php _e( 'Project Two', 'smartcube' ); ?></h2>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:heading -->
			<h2><?php _e( 'Project Three', 'smartcube' ); ?></h2>
			<!-- /wp:heading -->
 ...
 * Slug: smartcube/hero-cover-box
 * Categories: smartcube_hero
*/
?>
		...
		<div class="wp-block-group" style="padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem">
			...
			<div class="wp-block-column" style="flex-basis:50%">
				...
				<div class="wp-block-group has-foreground-color has-background-background-color has-text-color has-background" style="padding-top:3rem;padding-right:3rem;padding-bottom:3rem;padding-left:3rem">
					...
					<!-- wp:heading -->
					<h2><?php _e( 'Hero Headline', 'smartcube' ); ?></h2>
					<!-- /wp:heading -->
