...
/**
 * Title: Features Grid
 * Slug: smartcube/features-grid
 * Categories: smartcube_features
*/
?>
...
<div class="wp-block-group" style="margin-bottom:4vw">
	...
	<!-- wp:heading -->
	<h2><?php _e( 'Why choose us?', 'smartcube' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				...
				<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1","fontSize":"64px","fontStyle":"normal","fontWeight":"700"}}} -->
				<p style="font-size:64px;font-style:normal;font-weight:700;line-height:1">5</p>
				<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				...
				<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1","fontSize":"64px","fontStyle":"normal","fontWeight":"700"}}} -->
				<p style="font-size:64px;font-style:normal;font-weight:700;line-height:1">6</p>
				<!-- /wp:paragraph -->
