...
<div class="wp-block-group" style="margin-bottom:4vw">
	...
	<!-- wp:heading -->
	<h2><?php _e( 'What we have done', 'smartcube' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<!-- wp:heading {"level":3} -->
			<h3><?php _e( 'Project One', 'smartcube' ); ?></h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:heading {"level":3} -->
			<h3><?php _e( 'Project Two', 'smartcube' ); ?></h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:heading {"level":3} -->
			<h3><?php _e( 'Project Three', 'smartcube' ); ?></h3>
			<!-- /wp:heading -->
