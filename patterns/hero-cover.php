...
/**
 * Title: Hero Cover
 * Slug: smartcube/hero-cover
 * Categories: smartcube_hero
*/
?>

<!-- wp:cover {"url":"http://localhost/wp-content/themes/smartcube/assets/img/default-image.png","isRepeated":true,"dimRatio":80,"contentPosition":"center center","align":"wide"} -->
<div class="wp-block-cover alignwide is-repeated" style="background-image:url(http://localhost/wp-content/themes/smartcube/assets/img/default-image.png)">
	...
	<div class="wp-block-group has-white-color has-text-color" style="padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem">
		...
		<h1 class="is-style-underlined-heading"><?php _e( 'Hero Headline', 'smartcube' ); ?></h1>
		<!-- /wp:heading -->
