...
/**
 * Title: Service Page
 * Slug: smartcube/page-layout-services
 * Block Types: core/post-content
 * Categories: smartcube_page_layouts
*/
?>
...
<div class="wp-block-group" style="margin-bottom:4vw">
	...
	<!-- wp:heading {"level":1} -->
	<h1><?php _e( 'Our Services', 'smartcube' ); ?></h1>
	<!-- /wp:heading -->
...
<!-- wp:cover {"url":"http://localhost/wp-content/themes/smartcube/assets/img/default-image.png","isRepeated":true,"dimRatio":80,"contentPosition":"center center"} -->
<div class="wp-block-cover is-repeated" style="background-image:url(http://localhost/wp-content/themes/smartcube/assets/img/default-image.png)">
	...
	<div class="wp-block-group has-white-color has-text-color" style="padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem">
		...
		<!-- wp:paragraph -->
		<p><?php _e( 'Add a subtitle here', 'smartcube' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:heading {"level":1,"className":"is-style-underlined-heading"} -->
		<h1 class="is-style-underlined-heading"><?php _e( 'You are in good hands.', 'smartcube' ); ?></h1>
		<!-- /wp:heading -->
		...
		<div class="wp-block-buttons">
			<!-- wp:button -->
			<div class="wp-block-button"><a class="wp-block-button__link"><?php _e( 'Join now', 'smartcube' ); ?></a></div>
			<!-- /wp:button -->
...
<div class="wp-block-group" style="margin-top:4vw;margin-bottom:4vw">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<!-- wp:heading -->
			<h2><?php _e( 'What we offer', 'smartcube' ); ?></h2>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column" style="flex-basis:60%">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<!-- wp:heading {"level":3} -->
					<h3><?php _e( 'Service One', 'smartcube' ); ?></h3>
					<!-- /wp:heading -->
				...
				<div class="wp-block-column">
					...
					<!-- wp:heading {"level":3} -->
					<h3><?php _e( 'Service Two', 'smartcube' ); ?></h3>
					<!-- /wp:heading -->
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<!-- wp:heading {"level":3} -->
					<h3><?php _e( 'Service Three', 'smartcube' ); ?></h3>
					<!-- /wp:heading -->
				...
				<div class="wp-block-column">
					...
					<!-- wp:heading {"level":3} -->
					<h3><?php _e( 'Service Four', 'smartcube' ); ?></h3>
					<!-- /wp:heading -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33.33%">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button is-style-fill">
					<a class="wp-block-button__link has-primary-color has-white-background-color has-text-color has-background"><?php _e( 'Contact us', 'smartcube' ); ?></a>
				</div>
				<!-- /wp:button -->
...
<div class="wp-block-group" style="margin-bottom:4vw">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:30%">
			...
			<!-- wp:heading -->
			<h2><?php _e( 'What clients say', 'smartcube' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph -->
			<p><?php _e( 'What customers <br>think about us.', 'smartcube' ); ?></p>
			<!-- /wp:paragraph -->
